	...
	public class WeatherApiResponse
    {
        ...
        {	
	        ...
	        if (derece >= 337.5 || derece < 22.5)
		        yon = "Kuzey";
	        else if (derece >= 22.5 && derece < 67.5)
		        yon = "Kuzeydoğu";
	        else if (derece >= 67.5 && derece < 112.5)
		        yon = "Doğu";
	        else if (derece >= 112.5 && derece < 157.5)
		        yon = "Güneydoğu";
	        else if (derece >= 157.5 && derece < 202.5)
		        yon = "Güney";
	        else if (derece >= 202.5 && derece < 247.5)
		        yon = "Güneybatı";
	        else if (derece >= 247.5 && derece < 292.5)
		        yon = "Batı";
